                    ...
                    <div class="grid grid-padding-x grid-padding-y">
                        <div class="cell">
                            ...
                            <div>
                                ...
                                <input id="email" type="text" name="username" value="<?php echo $oUser->username; ?>" placeholder="<?php echo $oUser->username; ?>" disabled>
                            </div>
                            <div>
                                <label for="email">Email</label>
                                <input id="email" type="email" name="email" value="<?php echo $oUser->email; ?>" placeholder="<?php echo $oUser->email; ?>">
                            </div>
                            <div>
