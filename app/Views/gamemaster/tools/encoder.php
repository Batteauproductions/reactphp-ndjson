        ...
        <section class="grid-x grid-padding-x grid-padding-y">  
            <div id="encoder-wrapper" class="cell small-12">
                ...
                <form id="encoder-container" class="grid-x grid-padding-x grid-padding-y" data-equalizer data-equalize-on="medium">
                    <div class="cell small-12 medium-4 large-2" data-equalizer-watch>
                        ...
                        <a id="shift-letters" class="button solid"><i class="fa-solid fa-code"></i> Shift Letters</a>
                        <a id="copy-letters" class="button clear" disabled><i class="fa-solid fa-copy"></i> Resultaat kopieren</a>
                    </div>
                    <div class="cell small-12 medium-4 large-5" data-equalizer-watch>
                        <label for="input-text">Originele Text</label>
