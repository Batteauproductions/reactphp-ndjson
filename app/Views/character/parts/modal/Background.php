...
<div class="reveal large" id="background-modal" data-reveal>
    ...
    <?php if(!isset($oCharacter) || in_array($oCharacter->meta->status, CHARACTER_EDITABLE)): ?>
        <form id="background-form" class="grid-x grid-padding-x grid-padding-y" style="display:none;">
            ...
            <div id="ck-count-wrapper" class="cell small-12 text-left">	
                <div id="ck-count-container" >                
                    <textarea name="background" id="background" rows="30" maxlength="9000"><?php echo (isset($oCharacter->meta->background) ? $oCharacter->meta->background : ''); ?></textarea>								
    ...
    <?php else: ?>
        <h1 class="text-center">Achtergrond</h1>
        <hr>
        <div>
