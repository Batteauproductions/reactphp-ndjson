    ...
    <tr>
        <td style="padding: 0 0 20px;">
            <a href="<?= $sEmailLink; ?>" target="_blank"> 
                <img class="flex-image" src="<?= image_path('email/character_approved/header.jpg') ?>" height="auto" width="100%" style="display:block; height:auto; width:100%;"> 							
            </a>
        </td>
    </tr>
</table>
...
<table width="100%" style="width: 100%;">
    <tr>
        <td style="padding: 0 20px 20px; color: #FFFFFF; font: normal 16px/18px 'Manuale', serif;">
            ...
            Je personage <?= $char_name?> is door ons gecontroleerd en goed gekeurd!<br><br>
